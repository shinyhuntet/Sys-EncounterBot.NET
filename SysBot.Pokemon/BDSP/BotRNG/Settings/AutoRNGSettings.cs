...
namespace SysBot.Pokemon
{
	public class AutoRNGSettings
	{
        ...
        [Category(AutoRNG), Description("[AutoCalc] Enter syncNature.")]
        public bool ShinyCharm { get; set; } = false;

        [Category(AutoRNG), Description("[AutoCalc] Enter syncNature.")]
        public bool OvalCharm { get; set; } = false;
    ...
    public class EggRNGSettings
    {
        private const string EggRNG = nameof(EggRNG);

        [Category(EggRNG), Description("EggRNG Gender Filter.")]
        public Gender Gender { get; set; } = Gender.Genderless;

        [Category(EggRNG), Description("EggRNG Ability Filter.")]
        public AbilityNumber Ability { get; set; } = AbilityNumber.Nofilter;
    }
}